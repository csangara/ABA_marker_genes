...
subset_folder = os.environ['VSC_DATA_VO_USER'] + '/spatial_datasets/ABA_data/subset_merfish_genes/'
output_file = os.environ['VSC_DATA_VO_USER'] + '/spatial_datasets/ABA_data/WMB-10Xv3_subset_merfish_genes.h5ad'
...
# Download metadata
downsampled_csv = os.environ['VSC_DATA_VO_USER'] + '/spatial_datasets/ABA_data/cell_metadata_with_cluster_annotation.csv'
